...
public class Node<AnyType extends Comparable<? super AnyType>> implements Comparable<Node<AnyType>> {
	...
	public Node<AnyType> clone() {
		...
		return new Node<AnyType>( getData() );
	 ...
	 * 
	 */
	public int compareTo( Node<AnyType> node ) {
